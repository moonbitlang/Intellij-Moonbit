...
import com.github.moonbit.psi.MoonCatchExpression;
...
public class MoonCatchExpressionNode extends AnyMoonNode implements MoonCatchExpression {

    public MoonCatchExpressionNode(@NotNull ASTNode node) {
        super(node);
    }
