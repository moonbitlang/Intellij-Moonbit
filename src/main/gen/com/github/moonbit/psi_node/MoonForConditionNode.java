...
import com.github.moonbit.psi.MoonForCondition;
...
public class MoonForConditionNode extends AnyMoonNode implements MoonForCondition {

    public MoonForConditionNode(@NotNull ASTNode node) {
        super(node);
    }
