...
public class MbtiDeclareMethodNode extends AnyMbtiNode implements MbtiDeclareMethod {
    ...
    public MbtiDeclareMethodNode(@NotNull ASTNode node) {
        super(node);
    }
    ...
    public MbtiDeclareParameter getDeclareParameter() {
        return findNotNullChildByClass(MbtiDeclareParameter.class);
    }
    ...
    @Override
    @Nullable
    public MbtiTypeReturn getTypeReturn() {
        return findChildByClass(MbtiTypeReturn.class);
    }
